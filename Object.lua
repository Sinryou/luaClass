...
function Object:is(T)
	assert(type(T)=="table","Input of judge function must be a Class!")
...
function isClass(obj)
	assert(type(obj)=="table","Input of isClass function must be a Class or an Object!")
	for k,v in pairs(obj) do
		if k:find("__index") ~= nil and type(v)=="table" then
			return true
		end
	end
	return false
